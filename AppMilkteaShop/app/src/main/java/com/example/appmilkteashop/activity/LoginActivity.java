...
import com.example.appmilkteashop.service.JwtService;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void callApiLogin() {
        ...
        ApiService.apiService.loginUser(request).enqueue(new Callback<ResponseTokenDto>() {
            @Override
            public void onResponse(Call<ResponseTokenDto> call, Response<ResponseTokenDto> response) {
                if (response.isSuccessful()) {
                    ...
                    String role = JwtService.getRoleFromToken(token.getToken());
