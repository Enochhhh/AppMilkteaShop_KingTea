...
insert into user values ('USER3', 'PhanHongSon', '$2a$10$EvQVyzDZ0TCdUyWnY6.HeexR163RWlvixFgsWVdBJjaFM9nQDYwjm', 
	'CUSTOMER', '2023-09-05 16:48:20', N'Phan Hồng Sơn', N'22 Bình Chánh', 'enochphann@gmail.com', 
...
insert into contact values('CONT1', N'Lỗi đăng nhập', 'Tôi không thể đăng nhập vào tài khoản của mình', 
	'phanhongson234@gmail.com', '0785773779', N'Phan Hồng Sơn', null, true);
insert into contact values('CONT2', N'Trà Đào quá ngọt', 'Tôi đã đặt ly trà đào 50% đường nhưng sao nó vẫn ngọt ?', 
	'phanhongson234@gmail.com', '0785773779', N'Phan Hồng Sơn', 'USER3', true);
...
insert into category values('CATE1', N'Trà Sủi Bọt', 
    ...
    'https://firebasestorage.googleapis.com/v0/b/projectooad-651f1.appspot.com/o/Android%20Category%20Image%2Fsui_bot.png?alt=media&token=8322d556-e30f-4a74-a7e2-dd03c53ae8a6', true);
insert into category values('CATE2', N'Trà Con Gái', 
    ...
    'https://firebasestorage.googleapis.com/v0/b/projectooad-651f1.appspot.com/o/Android%20Category%20Image%2Fgirl.png?alt=media&token=5e148724-8efc-404c-97e4-f12d5de07912', true);
insert into category values('CATE3', N'Trà Sữa', 
    ...
    'https://firebasestorage.googleapis.com/v0/b/projectooad-651f1.appspot.com/o/Android%20Category%20Image%2Fmilktea.png?alt=media&token=f1b88992-71ba-4cde-8dd8-071181191f3e', true);
...
insert into custom_milktea values('CUSMT1', 44000, 4400, 'M', '50%', '70%', 'MTEA50', true);
insert into custom_milktea values('CUSMT2', 54000, 5400, 'L', '50%', '70%', 'MTEA50', true);
insert into custom_milktea values('CUSMT3', 64000, 6400, 'XL', '50%', '70%', 'MTEA50', true);
...
insert into order_shop values('ORD1', N'Phan Hồng Sơn', '0785773779', '22 Bình Chánh', 118000, 17700, 
	'2023-05-09 05:02:30', 'COD', 'Waiting Accept', null, 'USER3', true);
    
    
insert into order_line values(1, 'ORD1', 'CUSMT1', 118000, 17700, 2);
insert into order_line values(2, 'ORD1', 'CUSMT2', 64000, 6400, 1);
insert into order_line values(3, 'ORD1', 'CUSMT3', 231000, 23100, 3);